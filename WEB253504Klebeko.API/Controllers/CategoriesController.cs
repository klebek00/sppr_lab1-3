...
using WEB253504Klebeko.API.Services;
...
namespace WEB253504Klebeko.API.Controllers
{
    ...
    public class CategoriesController : ControllerBase
    {
        ...
        // GET: api/Categories
        [HttpGet]
        public async Task<ActionResult<ResponseData<Category[]>>> GetMedicineCategory()
        {
            var medCategory = await _categoryService.GetCategoryListAsync();
            return Ok(medCategory);
        }
